"""lancer_21857 URL Configuration
...
admin.site.site_header = "Lancer"
admin.site.site_title = "Lancer Admin Portal"
admin.site.index_title = "Lancer Admin"

# swagger
api_info = openapi.Info(
    title="Lancer API",
    default_version="v1",
    description="API documentation for Lancer App",
)
